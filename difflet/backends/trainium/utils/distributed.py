...
# Original path: neuronx_distributed_inference/utils/distributed.py
...
from difflet.backends.trainium.core.modules.attention.attention_process_groups import tp_mesh_8_by_8
