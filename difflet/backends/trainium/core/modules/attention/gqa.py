...
# Original path: neuronx_distributed_inference/modules/attention/gqa.py
...
from difflet.backends.trainium.core.modules.attention.utils import transpose_parallel_linear_layer
# Difflet fork: LLM-LoRA module check is not on the diffusion path. Stub returns
# False so any `if is_lora_module(...)` branch is skipped.
def is_lora_module(*args, **kwargs):  # type: ignore[no-redef]
    return False
# Original: from neuronx_distributed_inference.modules.lora_serving.lora_module import is_lora_module
