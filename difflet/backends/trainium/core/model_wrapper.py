...
# Original path: neuronx_distributed_inference/models/model_wrapper.py
...
from difflet.utils.tensor_replacement.registry import TensorReplacementRegister
import torch
...
# Difflet fork: async batched LLM execution + token sampling are not on the
# diffusion path. Stubbed to drop the runtime NxDI dependency. The diffusion
# pipeline drives generation step-by-step from the HF Pipeline subclass.
AsyncTensorWrapper = None  # type: ignore[assignment]
get_async_output = None  # type: ignore[assignment]
is_ranked_io = None  # type: ignore[assignment]
prepare_sampling_params = None  # type: ignore[assignment]
# Originals:
# from neuronx_distributed_inference.modules.async_execution import (
#     AsyncTensorWrapper, get_async_output, is_ranked_io,
# )
# from neuronx_distributed_inference.modules.generation.sampling import prepare_sampling_params
from neuronx_distributed.utils.tensor_capture import (
    enable_tensor_capture,
)
from difflet.backends.trainium.core.modules.padding import pad_with_first_batchline
