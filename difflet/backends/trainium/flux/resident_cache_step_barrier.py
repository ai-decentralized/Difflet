"""Single-NEFF H1f cache step with an explicit BF16 XLA barrier."""
...
class _BarrierCacheStepInstance(BaseModelInstance):
...
class _BarrierCacheStepWrapper(ModelWrapper):
    ...
    def get_model_instance(self):
        ...
        return _BarrierCacheStepInstance(_create)
...
class NeuronFluxResidentCacheStepBarrierApplication(NeuronApplicationBase):
    """H1f application retaining one scalar-only dispatch per skipped step."""
...
__all__ = ["NeuronFluxResidentCacheStepBarrierApplication"]
