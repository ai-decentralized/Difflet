"""Wan checkpoint conversion: HuggingFace diffusers → Difflet-loadable.
...
from difflet.models.wan.checkpoint.cli import convert_diffusers_checkpoint
from difflet.models.wan.checkpoint.text_encoder import (
