...
``difflet/utils/benchmark.py:LatencyCollector``", but that file is a
verbatim NxDI fork (rebase-tracked, black-excluded). This Difflet-authored
...
class LatentMetricCollector:
    ...
    def to_metrics_dict(self) -> dict[str, Any]:
        ...
        metrics: dict[str, Any] = {
            "schema": "difflet-latent-metrics-v1",
            "num_steps": n_steps,
