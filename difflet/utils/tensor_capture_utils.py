...
# Original path: neuronx_distributed_inference/utils/tensor_capture_utils.py
...
from difflet.backends.trainium.core.image_to_text_model_base import NeuronBaseForImageToText
