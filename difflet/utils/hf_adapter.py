...
# Original path: neuronx_distributed_inference/utils/hf_adapter.py
...
# Difflet fork: token sampling is LLM-only. Stubbed.
Sampler = None  # type: ignore[assignment]
prepare_sampling_params = None  # type: ignore[assignment]
# Original: from neuronx_distributed_inference.modules.generation.sampling import (
#     Sampler, prepare_sampling_params,
# )
