...
# Original path: neuronx_distributed_inference/utils/tensor_replacement/registry.py
# Fork date: 2026-05-08
# Modifications: (none — verbatim copy; see git log for divergence)
# <<< NxDI fork banner <<<
import os
import re
from difflet.backends.trainium.core.modules.attention.utils import order_strided_tensor, stride_tensor
import torch
