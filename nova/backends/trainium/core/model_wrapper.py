...
from nova.utils.tensor_replacement.registry import TensorReplacementRegister
import torch
...
# Nova fork: async batched LLM execution + token sampling are not on the
...
from nova.backends.trainium.core.modules.padding import pad_with_first_batchline
