...
from nova.backends.trainium.core.modules.attention.utils import transpose_parallel_linear_layer
# Nova fork: LLM-LoRA module check is not on the diffusion path. Stub returns
