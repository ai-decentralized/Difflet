...
def create_ltx_2_transformer_config(
    *,
    ...
    from nova.backends.trainium.ltx_2.transformer import LTX2TransformerInferenceConfig
...
def _load_ltx_2_host_pipeline(
    *,
    ...
    from nova.models.ltx_2.pipeline import disable_ltx_2_xla_lazy_import
