...
and writes Nova-compatible safetensors that NXD's load path can ingest
...
from nova.models.wan.checkpoint.backbone import convert_backbone_state_dict
from nova.models.wan.checkpoint.text_encoder import convert_text_encoder_state_dict
...
def convert_diffusers_checkpoint(
    ...
    *,
    ...
    Nova-renamed safetensors to ``out_dir/<component>/``.
