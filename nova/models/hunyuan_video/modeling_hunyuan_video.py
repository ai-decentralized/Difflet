...
layers, and ``nova.ops`` only; Trainium-specific compile/load wrappers live
under ``nova.backends.trainium``.
"""
...
class HunyuanVideoAttention(nn.Module):
    """HunyuanVideo joint attention using the Nova backend attention op."""
...
def dual_stream_attention(
    ...
    *,
    ...
    ``nova.ops.attention``, and splits the result back into the two streams.
    """
