...
#       .nova-cache/hunyuan_n4_20d40s2r/compiled/transformer/{model.pt,neuron_config.json}
...
#       .nova-cache/hunyuan_dit_inputs/<name>.safetensors + .meta.json
...
SOURCE_DIR="${NOVA_HUNYUAN_SOURCE_DIR:-/home/ubuntu/.cache/huggingface/hub/hunyuanvideo-real}"
COMPILED_DIR="${NOVA_HUNYUAN_COMPILED_DIR:-${ROOT}/.nova-cache/hunyuan_n4_20d40s2r/compiled}"
BUNDLE="${NOVA_HUNYUAN_BUNDLE:-${ROOT}/.nova-cache/hunyuan_dit_inputs/cat_walking_4step.safetensors}"
OUTPUT="${NOVA_HUNYUAN_OUTPUT:-/tmp/hunyuan_smoke.mp4}"
