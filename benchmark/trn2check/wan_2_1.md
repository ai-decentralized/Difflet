...
|---|---|---|---|---|---|
| per denoise step (transformer fwd) | 576.5 ms | 575.7 ms | 577.2 ms | 575.4 ms | 19 |
...
- per-step = 576.5 ms/DiT-step (median 575.7, p90 577.2, n=19) — measured the SAME way as H100: inter-step deltas of a real 20-step generate (wrapping NeuronWanBackboneApplication.__call__, synced, step 0 excluded), NOT the old isolated synthetic-input timer. 20 DiT calls timed; warm generate 348s; output finite=True.
